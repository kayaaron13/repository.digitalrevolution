...
# Python Koding AIO (c) by Made by Candy (info@totalrevolution.tv)
...
~"""
    ...
    elif 'Running on Made by Candy' in content or 'Running on LibreELEC' in content:

        if xbmc.getCondVisibility("System.HasAddon(service.Made by Candy.settings)") or xbmc.getCondVisibility("System.HasAddon(service.libreelec.settings)"):
            if xbmc.getCondVisibility("System.HasAddon(service.Made by Candy.settings)"): 
                xbmcaddon.Addon(id='service.Made by Candy.settings').getAddonInfo('name')
                xbmc.executebuiltin('RunAddon(service.Made by Candy.settings)')
